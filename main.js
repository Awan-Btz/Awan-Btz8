...
let authFile = `${opts._[0] || 'session'}.sean.json`
...
if (opts['test']) {
  ...
  conn.connect().then(() => {
 conn.sendMessage('62895411143170@c.us', 'Bot Telah Tersambung Ke Database Botz', 'conversation');
...
global.reloadHandler = function () {
  ...
  conn.spromote = 'Selamat!!! @user Sekarang Admin!'
  conn.sdemote = 'Selamat!!! @user Sekarang Bukan Admin!'

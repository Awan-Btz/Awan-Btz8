...
const fgif = {
  key: {
    ...
    ...{from: { remoteJid: "62895320853387-1621306547@g.us" }},
  },
  message: {
    videoMessage: {
      title: `Botz`,
...
const fcon = {
	 ...
	 message: { "contactsArrayMessage": { "title":"©LoyoBotz","h": `aloo`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
const ftextt = {
	 key: { 
          fromMe: false,
